...
var legacyAlias = map[string][]string{
	...
	"ep":          {"voice", "endpoints"},
	"brand":       {"message", "10dlc", "brands"},
	"campaign":    {"message", "10dlc", "campaigns"},
	"camp":        {"message", "10dlc", "campaigns"},
	"link":        {"message", "10dlc", "links"},
	"powerpack":   {"message", "powerpacks"},
	"pp":          {"message", "powerpacks"},
	"tollfree":    {"message", "tollfree"},
	"tfv":         {"message", "tollfree"},
	"number":      {"numbers"},
	"cnam":        {"numbers", "cnam"},
