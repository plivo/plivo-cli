...
### Added
- `plivo buddy chat` + `plivo buddy escalations` — talks to Plivo Buddy via
  `/v1/aiassist/buddy-ext` (SSE streaming, Plivo Basic auth). Ctrl-C cancels
  cleanly; `-o json` emits JSONL events for scripts and AI agents.
